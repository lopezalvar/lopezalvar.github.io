...
Después de recibir estos Packet-In, el controlador es capaz de descubrir los enlaces entre dos switches OF, basándose en la información contenida en la LLDPPDU y los datos extraidos de los metadatos. El controlador almacena esta información en la base de datos y a partir de este momento realizará actualizaciones sobre esta base de datos.
